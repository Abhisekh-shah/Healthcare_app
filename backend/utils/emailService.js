...
// // Rest of your email templates remain the same...
...
// const appointmentStatusEmail = (patientName, status, date, timeSlot) => ({
...
//         <p>Dear <strong>${patientName}</strong>,</p>
//         <p>Your appointment on <strong>${new Date(date).toDateString()}</strong> at <strong>${timeSlot.startTime}</strong> has been <strong>${status}</strong>.</p>
...
// // Fixed: Remove extra "Doctor" label and just show the name
// const appointmentConfirmationEmail = (patientName, doctorName, date, timeSlot) => ({
//   subject: 'Appointment Booking Confirmed',
//   html: `
//     <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
...
//       <div style="padding: 24px; background: #f9fafb;">
//         <p>Dear <strong>${patientName}</strong>,</p>
//         <p>Your appointment with <strong>${doctorName || 'the doctor'}</strong> on <strong>${new Date(date).toDateString()}</strong> at <strong>${timeSlot?.startTime || 'scheduled time'}</strong> has been <strong>${status}</strong>.</p>
//         ${status === 'rejected' || status === 'cancelled' ? '<p>Please book another appointment at your convenience.</p>' : ''}
//       </div>
//     </div>
//   `,
